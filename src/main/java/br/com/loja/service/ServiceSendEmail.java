...
public class ServiceSendEmail {
	...
	private String userName = "tiagosimaodevtest@gmail.com";
	private String senha = "xwzn hzxz omyk twur";
	...
	public void enviarEmailHtml(String assunto, String mensagem, String emailDestino) throws UnsupportedEncodingException, MessagingException {
		...
		message.setFrom(new InternetAddress(userName, "tiago - java", "UTF-8"));
