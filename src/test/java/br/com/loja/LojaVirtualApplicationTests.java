...
public class LojaVirtualApplicationTests extends TestCase {
	...
	public void testeRestApiCadastroAcesso() throws JsonProcessingException, Exception {
		...
		// responsáveis por efetuar os testes, com requisições etc.
	...
	@Test
	public void testeRestApiBuscarAcessoDesc() throws JsonProcessingException, Exception {
		...
		acesso.setDescricao("ROLE_TESTE_BUSCAR_LIST");
		...
		ResultActions retornoApi = mockMvc
					.perform(MockMvcRequestBuilders.get("/buscarPorDesc/BUSCAR_LIST")
					.content(objectMapper.writeValueAsString(acesso))
					.accept(MediaType.APPLICATION_JSON)
					.contentType(MediaType.APPLICATION_JSON));
	...
	public void testCadastraAcesso() throws ExceptionLojaVirtual {
		...
		String descricacesso = "ROLE_ADMIN" + Calendar.getInstance().getTimeInMillis();
		
		Acesso acesso = new Acesso();
		
		acesso.setDescricao(descricacesso );
	...
	//	validar dados salvos da forma correta
		assertEquals(descricacesso, acesso.getDescricao());
